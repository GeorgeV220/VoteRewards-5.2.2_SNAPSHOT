...
public class DiscordWebHook {
    ...
    public static EmbedObject buildFromConfig(FileConfiguration fileConfiguration, String path) {
        return new EmbedObject().setTitle(fileConfiguration.getString(path + ".title"))
                .setDescription(fileConfiguration.getString(path + ".description"))
                .setColor(Color.from(fileConfiguration.getString(path + ".color")))
                .addFields(new DiscordWebHook.EmbedObject.Field("", "", false))
                .setThumbnail(fileConfiguration.getString(path + ".thumbnail url"))
                .setFooter(fileConfiguration.getString(path + ".footer.message"),
                        fileConfiguration.getString(path + ".footer.icon url"))
                .setImage(fileConfiguration.getString(path + ".image url"))
                .setAuthor(fileConfiguration.getString(path + ".message"), fileConfiguration.getString(path + ".url"),
